        ...
        <div className="w-full">
          ...
          <div className="mx-auto flex max-w-lg flex-col items-center text-center">
            ...
            <div className="mt-6 flex w-full items-center gap-x-3 sm:w-auto">
              <button
                onClick={() => navigate(-1)}
                className="flex w-1/2 items-center justify-center gap-x-2 rounded-lg border bg-white px-5 py-2 text-sm text-gray-700 transition-colors duration-200 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 dark:border-gray-700 sm:w-auto"
              >
                <svg
                ...
                >
                  <path
                    ...
                    d="M6.75 15.75L3 12m0 0 3.75-3.75M3 12h18"
                  />
                </svg>
                <span>Go back</span>
              </button>
              ...
              <Link
                to="/"
                className="w-1/2 shrink-0 rounded-lg bg-blue-500 px-5 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 sm:w-auto"
              >
                Take me home
              </Link>
            </div>
